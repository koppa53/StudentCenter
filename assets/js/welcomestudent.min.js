...
let idcs = document.querySelector("#idcs");
var result ;
var timetables = [
    ['', '', '', '', '', '', '', '', '', '', '', '','','','','','','','','','','','','','','','','','','',''],
    ['', '', '', '', '', '', '', '', '', '', '', '','','','','','','','','','','','','','','','','','','',''],
...
async function fetchUserName() {
    ...
    fetchCurrentGrades(t.school_id)
}

async function fetchCurrentGrades(sid){
    ...
    sem1.innerHTML = "Current Status of Grades - ("+ result[0].academic_term_name + " )";
    sem2.innerHTML = "Current List of Schedule - ("+ result[0].academic_term_name + " )";
    idcs.innerHTML = sid + ":  " + result[0].course_name +" " +result[0].course_schedule_year_level
